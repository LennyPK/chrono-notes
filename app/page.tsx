      ...
      <main className="flex-1">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Become focused, organized, and calm with ChronoNotes. The world's #1 task manager and note-taking app.
                  </p>
                </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  ChronoNotes combines powerful task management with intuitive note-taking to help you achieve more every
                  day.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col items-center space-y-2 rounded-lg border bg-background p-6 shadow-sm">
                ...
                <p className="text-center text-muted-foreground">
                  Create, organize, and prioritize tasks with ease. Set due dates, reminders, and recurring tasks.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border bg-background p-6 shadow-sm">
                <div className="rounded-full bg-primary/10 p-3">
                ...
                <p className="text-center text-muted-foreground">
                  Automatically organize tasks into Today, Upcoming, and custom smart lists based on your criteria.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border bg-background p-6 shadow-sm">
                <div className="rounded-full bg-primary/10 p-3">
                ...
                <p className="text-center text-muted-foreground">
                  Stay focused with built-in Pomodoro timer. Track your productivity and build better habits.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border bg-background p-6 shadow-sm">
                <div className="rounded-full bg-primary/10 p-3">
                ...
                <p className="text-center text-muted-foreground">
                  Create rich notes with Markdown support. Link notes together for a personal knowledge base.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border bg-background p-6 shadow-sm">
                <div className="rounded-full bg-primary/10 p-3">
                ...
                <p className="text-center text-muted-foreground">
                  Build and maintain habits with our built-in habit tracker. Visualize your progress over time.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border bg-background p-6 shadow-sm">
                <div className="rounded-full bg-primary/10 p-3">
                ...
                <p className="text-center text-muted-foreground">
                  Access your tasks and notes from anywhere. Sync across all your devices seamlessly.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  See what our users have to say about how ChronoNotes has transformed their productivity.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col justify-between rounded-lg border bg-background p-6 shadow-sm">
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    "ChronoNotes has completely transformed how I organize my work and personal life. The combination of
                    task management and notes is perfect."
                  </p>
                </div>
              ...
              <div className="flex flex-col justify-between rounded-lg border bg-background p-6 shadow-sm">
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    "As a student, ChronoNotes helps me keep track of assignments, deadlines, and research notes all in one
                    place. The Obsidian-like linking is amazing!"
                  </p>
                </div>
                <div className="mt-6 flex items-center space-x-3">
                  <div className="h-10 w-10 rounded-full bg-muted" />
              ...
              <div className="flex flex-col justify-between rounded-lg border bg-background p-6 shadow-sm">
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    "I've tried dozens of productivity apps, and ChronoNotes is by far the best. The Today view helps me
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col rounded-lg border bg-background p-6 shadow-sm">
                ...
                <div className="mt-6">
                  <Link
                    href="/auth/signup"
                    className="inline-flex h-10 w-full items-center justify-center rounded-md bg-primary px-8 text-sm font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1"
                  >
                    Get Started
                  </Link>
                </div>
              ...
              <div className="flex flex-col rounded-lg border bg-background p-6 shadow-sm relative">
                ...
                <ul className="mt-6 space-y-3">
                  ...
                  <li className="flex items-center">
                    <CheckCircle2 className="mr-2 h-4 w-4 text-primary" />
                    <span>Full note-taking with linking</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle2 className="mr-2 h-4 w-4 text-primary" />
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">Ready to get organized?</h2>
                <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Join thousands of users who have transformed their productivity with ChronoNotes.
                </p>
              </div>
              <div className="flex flex-col gap-2 min-[400px]:flex-row">
                <Link
      ...
      <footer className="border-t bg-muted/40">
        <div className="container flex flex-col gap-6 py-8 md:py-12 px-4 md:px-6">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-2">
              <CheckCircle className="h-6 w-6 text-primary" />
              <span className="text-lg font-bold">ChronoNotes</span>
            </div>
            <p className="text-sm text-muted-foreground">
              &copy; {new Date().getFullYear()} ChronoNotes, Inc. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
